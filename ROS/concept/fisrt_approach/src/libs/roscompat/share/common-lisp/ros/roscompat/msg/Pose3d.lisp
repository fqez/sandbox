...
(cl:defmethod cl:initialize-instance :after ((m <Pose3d>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose3d)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscompat-msg:<Pose3d> is deprecated: use roscompat-msg:Pose3d instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Pose3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscompat-msg:x-val is deprecated.  Use roscompat-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Pose3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscompat-msg:y-val is deprecated.  Use roscompat-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Pose3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscompat-msg:z-val is deprecated.  Use roscompat-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'h-val :lambda-list '(m))
(cl:defmethod h-val ((m <Pose3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscompat-msg:h-val is deprecated.  Use roscompat-msg:h instead.")
  (h m))

(cl:ensure-generic-function 'q0-val :lambda-list '(m))
(cl:defmethod q0-val ((m <Pose3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscompat-msg:q0-val is deprecated.  Use roscompat-msg:q0 instead.")
  (q0 m))

(cl:ensure-generic-function 'q1-val :lambda-list '(m))
(cl:defmethod q1-val ((m <Pose3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscompat-msg:q1-val is deprecated.  Use roscompat-msg:q1 instead.")
  (q1 m))

(cl:ensure-generic-function 'q2-val :lambda-list '(m))
(cl:defmethod q2-val ((m <Pose3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscompat-msg:q2-val is deprecated.  Use roscompat-msg:q2 instead.")
  (q2 m))

(cl:ensure-generic-function 'q3-val :lambda-list '(m))
(cl:defmethod q3-val ((m <Pose3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscompat-msg:q3-val is deprecated.  Use roscompat-msg:q3 instead.")
  (q3 m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Pose3d>)))
  ...
  "9fcf1c8fc344bc3dd0b6740d4de1f9d2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Pose3d)))
  "Returns md5sum for a message object of type 'Pose3d"
  "9fcf1c8fc344bc3dd0b6740d4de1f9d2")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Pose3d>)))
  ...
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 h~%float64 q0~%float64 q1~%float64 q2~%float64 q3~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Pose3d)))
  "Returns full string definition for message of type 'Pose3d"
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 h~%float64 q0~%float64 q1~%float64 q2~%float64 q3~%~%~%"))
