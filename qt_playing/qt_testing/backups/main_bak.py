...
class ExampleWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        img = QImage('/home/fran/github/BehaviorSuite/qt_testing/assets/logo.svg')
        ...
        font = QFont('Arial', 20)
        self.clk_label = ClickableLabel(self)
        ...
        self.clk_label.setStyleSheet('color: white')     
   
        font = QFont('Techno Capture', 36)
